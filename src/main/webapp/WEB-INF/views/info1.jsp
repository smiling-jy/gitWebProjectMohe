...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="padding:30px">
        <div class="image-layer lazy-image" data-bg="url('resources/images/mohe_logo/info/info_main_img3.jpg')"></div>
    ...
    <section class="team-carousel-section " style="bottom:0px; padding:0px; margin:100px 0px">
