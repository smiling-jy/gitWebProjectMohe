			...
			<div class="">
				<div class="page-title">
					...
					<div>
						...
						<div id="search">
							<form name="search" action="adminList.do" method="post">
								<select name="select">
									<option value="adm_id">ID</option>
									<option value="adm_name">이름</option>
									<option value="adm_phone">핸드폰</option>
									<option value="adm_dept">등급</option>
								</select>
					...
					<div class="content_table_div">
						...
						<div class="link-box btn_tb_mg">
							<h2><a href="adminInsertInfo.do" class="theme-btn btn-style-ten"> <span
								class="btn-title">추가하기</span>
							</a></h2>
