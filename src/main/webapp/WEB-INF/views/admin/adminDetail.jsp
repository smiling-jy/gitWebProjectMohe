				...
				<div class="page-title">
					...
					<div class="content_table_div">
						...
						<div class="link-box btn_tb_mg right_btn">
							<h2><a href="adminEnd.do?adm_no=${admin.adm_no}" class="theme-btn btn-style-three">
								<span class="btn-title">사용불가 전환</span>
							</a></h2>
							<h2><a href="adminUpdateInfo.do?adm_no=${admin.adm_no}" class="theme-btn btn-style-one"> 
								<span class="btn-title">관리자정보 수정</span>
							</a></h2>
						</div>
						<!-- 버튼끝 -->
