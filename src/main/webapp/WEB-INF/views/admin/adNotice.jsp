		...
		<div class="col-md-push-9 right_col content_right" role="main">
			<div class="">
				<div class="page-title">
					...
					<!-- 서치 부분 시작 -->
					<div>
						<div class="text_size_title">공지사항</div>
						<div id="search">
							<form name="search" action="adNotice.do" method="post">
								<select name="select">
					...
					<div class="content_table_div">
						...
						<div class="link-box btn_tb_mg">
							<h2><a href="adNoticeInsertInfo.do" class="theme-btn btn-style-ten">
									...
									<div class="table-column">
										<div class="inner-column">
											<div class="table-outer">
												<div class="table-box">
													<div id="exportExcel_name">notice</div>
															...
															<c:forEach items="${notice}" var="ntc">
																<tr>
																	...
																	<td style="word-break:break-all">
																		<a href="adNoticeUpdateInfo.do?notice_no=${ntc.notice_no}" class="remove-btn"> 
