                    ...
                    <div class="title-column">
                    	...
                    	<div class="inner">
                            ...
                            <ul class="tab-buttons">
                            	<li class="tab-btn active-btn" style="font-size:20px" data-tab="#tab-1">펀딩</li>
                        	...
                        	<div class="tabs-content">
                                ...
                                <div class="tab active-tab" id="tab-1">
                                    <ul class="accordion-box clearfix">
                                        ...
                                        <li class="accordion block active-block">
                                            <div class="acc-btn active">Q. 추석 연휴기간 펀딩상품 배송은 어떻게 되나요?</div>
                                ...
                                <div class="tab" id="tab-2">
                                    <ul class="accordion-box clearfix">
                                        <!--Block-->
                                        <li class="accordion block active-block">
                                            <div class="acc-btn active">Q. What is the Cancelation Period?</div>
                                            <div class="acc-content current">
                                                <div class="content">
                                                    <div class="text">Lorem ipsum dolor amet consectetur adipisicing  sed do eiusmod tempor incididunt ut labore magna aliqua enim minim veniam quis nostrud.</div>
                                                </div>
        ...
        <br>
            <div class="auto-container" id="admin-email">
                <div class="inner clearfix" id="admin-email-inner">
                         <h4 style="text-align:center; color: white; display: inline;">무엇이든 문의하세요</h4><img src="resources/images/mohe_logo/main_logo.png">
