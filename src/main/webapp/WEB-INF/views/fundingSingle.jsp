                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="cause-details">
                        <div class="inner-box">
                            <!-- 타이틀 이미지 영역 -->
                            <div class="image-box">
                                <figure class="image"><img class="lazy-image" src="resources/images/resource/image-spacer-for-validation.png" data-src="resources/images/resource/cause-image-7.jpg" alt=""></figure>
                            </div>
                            <div class="donate-info">
                                ...
                                <div class="donation-count clearfix"><span class="raised"><strong>현재금액</strong> 6,000원</span> <span class="goal"><strong>목표금액:</strong> 8,000원</span></div>
                            </div>
                            <!-- 첨부파일 영역 -->
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar" id="new-side">
                            ...
                            <div class="new-font" id="funding-div">
                                    <a href="fundingPay.html" class="theme-btn btn-style-one link-box"><span class="btn-title new-font new-btn-title">펀딩하기</span></a>
                                    <button class="funding-btn" id="jjim">♥</button>
                                    <button class="funding-btn" id="gongu"><span class="flaticon-share"></span></button>
                            </div>
                    </aside>
                </div>
            </div>
