    ...
    <div class="sidebar-page-container" >
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-13 col-md-12 col-sm-12" style="text-align:center;">
                    <!--Blog Posts-->
                    <div class="blog-post-detail" >
                        <div class="inner">
                        	<div class="post-meta">
                                <ul class="clearfix">
                                    <li><a href="#"><span class="icon fa fa-user"></span> MOHE 관리자</a></li>
                                    <li><a href="#"><span class="icon fa fa-comments"></span> 2022.03.21</a></li>
                                </ul>
                            </div>
                     ...
                     <div>
                            <h5>[ 이전글 ]</h5>
                            <h5 class="prev-next-post"><a style="color:black;" href="#">처음 여는 펀딩이라면? 여기를 주목하세요! </a></h5>
                    ...
                    <div>      
                            <h5>[ 다음글 ]</h5>
                            <h5 class="prev-next-post"><a style="color:black;" href="#" >모해-공공기관 협력 후원 행사 설명회 참석 신청 안내</a></h5>
                                <span>2022. 08. 06</span>
                    </div> 
                    <br><br>
                    <div class="donate-link"><a href="notice.html" class="theme-btn btn-style-one"><span class="btn-title">목록으로</span></a></div>
