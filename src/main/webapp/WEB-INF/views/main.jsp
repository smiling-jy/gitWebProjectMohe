...
<div class="page-wrapper">
    ...
    <section class="banner-section style-two slid_fix">
		<div class="banner-carousel love-carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 300, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'>
			...
			<div class="slide-item slid_fix">
                ...
                <div class="image-layer lazy-image" data-bg="url('resources/images/main-slider/imsi-slider2.png')"></div>
				<div class="auto-container">
                    <div class="content-box" style="top:-150px">
						<h2>5만원 쿠폰팩<br>민트 페스티벌에 초대합니다</h2>
					</div>  
				</div>
			</div>
			<!-- Slide Item -->
    ...
    <div class="image wow fadeInDown" id="partner_section">
        <div id="main_Partner_div">
            ...
            <div id="rotation_partner_div">
                <a href="#"><img src="resources/images/partner_logo/partner_logo_01.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_02.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_03.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_04.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_05.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_06.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_07.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_08.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_09.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_10.jpg"/></a>
                <a href="#"><img src="resources/images/partner_logo/partner_logo_11.jpg"/></a>
            </div>
        </div>
    </div>
                ...
                <div class="team-carousel love-carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 5000, "smartSpeed": 500, "responsive":{ "0" :{ "items": "1" },"600" :{ "items": "1" }, "800" :{ "items" : "2" }, "1024":{ "items" : "3" }, "1366":{ "items" : "3" }}}'>
                    <div class="slide-item">
                        ...
                        <div class="team-block">
                            <div class="inner-box">
                                <figure class="image-box"><a href="#"><img src="resources/images/mohe_logo/logo_mint_big.png" alt=""></a></figure>
                                <div class="lower-box">
                                    <div class="content">
                                        <h3><a href="#"></a>우리지구는 일회용이 아니야</h3>
    ...
    <!-- 마감 임박 봉사 섹션 -->
    	<!--Team Carousel Section-->
        <section class="team-carousel-section " style="bottom:0px; padding:0px">
    ...
    <section class="donate_section">
        ...
        <div class="donate_div image wow fadeInUp"><img src="resources/images/mohe_logo/gibubener_1.png">
        	<div class="mission">
                	...
                	<div class="text-column col-lg-6 col-md-12 col-sm-12">
                    	<div class="inner">
                            <div class="sec-title" style="margin-top:80px">
                                ...
                                <div class="link-box"><a href="donate.html" class="theme-btn btn-style-three"><span class="btn-title">Donate</span></a></div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- 리뷰 섹션1 -->
    	<!--Team Carousel Section-->
        <section class="team-carousel-section " style="bottom:0px; padding:0px; margin-top:100px">
        ...
        <!-- 리뷰 섹션2 -->
    	<!--Team Carousel Section-->
        <section class="team-carousel-section " style="bottom:0px; padding:0px; margin-top:100px; margin-bottom:100px;">
...
<script>
    ...
    function fnSlide() {
        $("#rotation_partner_div").animate({ "margin-left": "-300px" },1000, function () {
            $("#rotation_partner_div").css({ "margin-left": "0px" });
            $("#rotation_partner_div a:first-child").insertAfter("#rotation_partner_div a:last-child");
        });
    };
</script>
</body>
