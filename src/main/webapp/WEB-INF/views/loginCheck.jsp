...
<script  type="text/javascript">
   window.onload = function(){
      ...
      document.getElementById('Submit_email_login').onclick = check;   
   }
   ...
   <div class="page-wrapper">
      ...
      <div class="container">
         <section class="wrapper">
            ...
            <form name="signin" class="form" action="loginCheck.do">
               <div class="input-control">
                  <label for="user_email" class="input-label" hidden>이메일</label>
                  <input
                     type="text" name="user_email" id="user_email" class="input-field"
                     placeholder="이메일">
               </div>
               <div class="input-control">
                  <label for="user_password" class="input-label" hidden>비밀번호</label>
                  <input
                     type="text" name="user_password" id="user_password" class="input-field"
                     placeholder="비밀번호">
               </div>
               <div class="input-control">
                  ...
                  <div class="donate-link">
                     ...
                     <a href="#" class="theme-btn btn-style-one"> <span id="submit_email_login" 
                        class="btn-title text-center"><button id="log">로그인</button>
                        </span>
                     </a>
                  </div>
               </div>
