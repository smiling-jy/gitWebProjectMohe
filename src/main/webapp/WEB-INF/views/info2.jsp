...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="page-banner" style="height: 550px">
			...
			<div class="auto-container">
				...
				<div style="left: 0px; width: 370px; margin-top: 50px;">
					...
					</a> <a href="cause-single.html" class="theme-btn btn-style-one"> <span
		...
		<!--What We Do Section-->
		<section class="what-we-do what_div"
			style="margin-bottom: 0px; padding-bottom: 100px;">
			...
			<div class="auto-container">
				<div class="row clearfix">
					<!--Service Block-->
					<div
						class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-12 block_back image wow fadeInUp service_fix">
						<div class="inner-box">
							<div class="icon-box">
					...
					<!--Service Block-->
					<div
						class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-12 block_back image wow fadeInDown service_fix2">
						<div class="inner-box">
							<div class="icon-box">
							...
							<h3>봉사</h3>
							<div class="text">
								내가 할수있는 봉사가 있을까?<br>지역별 봉사모임이 궁금하다면
							</div>
							<div
								style="left: 0px; width: 370px; margin-top: 50px; margin-left: 45px;">
