            ...
            <div class="mixitup-gallery">
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        <li class="filter active" data-role="button" data-filter=".mix-1">이메일 찾기</li>
                        <li class="filter" data-role="button" data-filter=".mix-2">비밀번호 찾기</li>
                    </ul>
                </div>
                    ...
                    <main class="gallery-item-two mix mix-1 main">
                        <section class="wrapper">
                              <div class="heading">
                                ...
                                <span class="text text-normal">모해는 이메일을 아이디로 사용합니다.
                                    소유하고 계신 계정을 입력해보세요.
                                    가입여부를 확인해드립니다.
                                </span>
                              </div>
                              <form name="signin" class="form">
                                ...
                                <div class="donate-link">
                                  <a href="donate.html" class="theme-btn btn-style-one btn-block">
                                      <span class="btn-title text-center">이메일 찾기</span>
                                  </a>
                              </div>
                              </form>
                        </section>
                        ...
                        <main class="gallery-item-two mix mix-2 main">
                            <section class="wrapper">
                                  ...
                                  <form name="signin" class="form">
                                    ...
                                    <div class="donate-link">
                                      <a href="donate.html" class="theme-btn btn-style-one btn-block">
                                          <span class="btn-title text-center">비밀번호 찾기</span>
                                      </a>
                                  </div>
                                  </form>
                            </section>
