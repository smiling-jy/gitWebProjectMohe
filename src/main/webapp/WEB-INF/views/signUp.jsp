      ...
      <div class="container">
        <section class="wrapper">
          <div class="heading">
            ...
            <span class="text text-normal">모해에 가입해 기부와 펀딩을 이용해 보세요
            </span>
          </div>
          <form name="signin" class="form">
            ...
            <div class="input-control">
              <label for="password_check" class="input-label" hidden>비밀번호 확인</label>
              <input type="password_check" name="password_check" id="password_check" class="input-field" placeholder="비밀번호 확인">
            </div>
            <div class="input-control">
            ...
            <div class="input-control">
              <label for="phone" class="input-label" hidden>핸드폰 번호</label>
              <input type="phone" name="phone" id="phone" class="input-field" placeholder="핸드폰 번호">
            </div>
            <div class="my-4">
              <div class="custom-control custom-checkbox mb-3">
                <input type="checkbox" class="custom-control-input" id="agree-terms" name="agree-terms">
                <label class="custom-control-label" for="agree-terms"><a href="/service/terms" target="_blank">이용약관</a> 동의 </label>
              </div>
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="privacy-terms" name="privacy-terms">
                <label class="custom-control-label" for="privacy-terms"><a href="/privacy/policy" target="_blank">개인정보 취급방침</a> 동의 </label>
              </div>
            </div>
          ...
          <div class="method">
            <div class="method-control">
              <a href="#" class="method-action">
                ...
                <span style="margin-left: 0.3rem;">구글로 회원가입</span>
              </a>
            </div>
            <div class="method-control">
              <a href="#" class="method-action">
