                    ...
                    <div class="inner-column">
                        <div class="table-outer">
                                        ...
                                        <tr>
                                            <td colspan="2" class="prod-column">
                                                <div class="column-box">
                                                    <figure class="prod-thumb"><a href="#"><img class="lazy-image" src="resources/images/resource/image-spacer-for-validation.png" data-src="resources/images/resource/products/prod-thumb-1.jpg" alt=""></a></figure>
                            ...
                            <div class="coupon-outer">
                                ...
                                <div class="link-box">
                                    <button type="button" class="theme-btn btn-style-one cart-btn"><span class="btn-title new-btn-title">펀딩하기</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
