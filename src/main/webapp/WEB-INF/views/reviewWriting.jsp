		...
		<section class="wrapper">
			...
			<form name="signin" class="form">
				<div class="input-control">
					<input type="text" name="text" id="text" class="input-field" placeholder="제목을 입력해주세요">
				</div>
				<div class="input-control">
					<textarea type="text" name="text" id="text" class="input-field" placeholder="본문을 입력해주세요" rows="5"></textarea>
				</div>
				<div class="input-control">
					<div class="donate-link">
						<a href="donate.html" class="theme-btn btn-style-one">
							<span class="btn-title text-center">작성하기</span>
						</a>
					</div>
				</div>
			</form>
